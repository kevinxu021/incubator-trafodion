 ...
 */         cmd.CommandText = "get service";
            ...
            TrafDbDataReader[] readers = new TrafDbDataReader[this.ParallelStreams];
        ...
        {
            TrafDbDataReader dr = this._consumers[1].DataReader;
