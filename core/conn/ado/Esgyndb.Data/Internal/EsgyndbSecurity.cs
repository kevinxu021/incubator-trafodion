...
namespace Esgyndb.Data
{
    ...
    {
        public byte[] id = new byte[EsgyndbSecurity.PWDID_SIZE];
        public byte[] rolename = new byte[EsgyndbSecurity.ROLENAME_SIZE];
        public byte[] digest = new byte[EsgyndbSecurity.DIGEST_LENGTH];
        public byte[]  ts = new byte[EsgyndbSecurity.TIMESTAMP_SIZE];
        public LoginData data;         
    }

    internal class LoginData 
    {
        public byte[] session_key = new byte[EsgyndbSecurity.SESSION_KEYLEN];
        public byte[] nonce = new byte[EsgyndbSecurity.NONCE_SIZE];
    }

    internal class EsgyndbSecurity
    {
        ...
        public EsgyndbSecurity(EsgyndbConnection conn, string directory, string fileName,
