namespace Esgyndb.Data.ETL
{
    ...
    /// <summary>
    /// Represents a Esgyndb Transporter parallel extract operation
    /// </summary>
    public class EsgyndbParallelExtract : IDisposable
    {
        ...
        /// <summary>
        /// Creates an array of EsgyndbDataReaders for the associated CommandText
        /// </summary>
        /// <returns>An array of EsgyndbDataReaders</returns>
        public EsgyndbDataReader [] Execute()
        {
            // use a single ConnectionStringBuilder for all the connections
            EsgyndbConnectionStringBuilder csb = new EsgyndbConnectionStringBuilder(this.ConnectionString);

            this._producer = new EsgyndbConnection(csb.ConnectionString);
            this._producer.Open();
 ...
 */         cmd.CommandText = "get service";
            ...
            EsgyndbDataReader[] readers = new EsgyndbDataReader[this.ParallelStreams];
        ...
        {
            EsgyndbDataReader dr = this._consumers[1].DataReader;
