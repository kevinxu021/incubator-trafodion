namespace EsgynDB.Data.ETL
{
    ...
    {
        private EsgyndbParallelExtract _extractor;

        private EsgynDBConnection _conn;
        private EsgynDBCommand _cmd;
        private EsgynDBDataReader _dr;
        ...
        public ParallelConsumer(EsgyndbParallelExtract extractor, string connectionString, string commandText, int id)
        {
        ...
        public EsgynDBDataReader DataReader
        {
            get
            {
                return this._dr;
        ...
        private void ExecuteProc()
        {
            try
            {
                this._conn = new EsgynDBConnection(this._connectionString);
                this._conn.Open();
