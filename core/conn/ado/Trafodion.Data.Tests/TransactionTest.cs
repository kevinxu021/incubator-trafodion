...
namespace TrafAdoTest
{
    ...
    public class TransactionTest
    {
        ...
        private TrafDbCommand myCommand;
        ...
        public void Commit()
        {
            ...
            TrafDbTransaction myTrans = testInfo.connection.BeginTransaction();
        ...
        public void IsolationLevelReadCommitted()
        {
            ...
            // Start a local transaction.
            TrafDbTransaction myTrans = testInfo.connection.BeginTransaction(System.Data.IsolationLevel.ReadCommitted);
            // Enlist the command in the current transaction.
            myCommand.Transaction = myTrans;
        ...
        public void IsloationLevelReadUncommitted()
        {
            ...
            // Start a local transaction.
            TrafDbTransaction myTrans = testInfo.connection.BeginTransaction(System.Data.IsolationLevel.ReadUncommitted);
            // Enlist the command in the current transaction.
            myCommand.Transaction = myTrans;
            try
            {
        ...
        public void IsloationLevelChaos()
        {
            ...
            // Start a local transaction.
            TrafDbTransaction myTrans = testInfo.connection.BeginTransaction(System.Data.IsolationLevel.Chaos);
            // Enlist the command in the current transaction.
            myCommand.Transaction = myTrans;
            try
            {
        ...
        public void IsloationLevelUnspecified()
        {
            ...
            // Start a local transaction.
            TrafDbTransaction myTrans = testInfo.connection.BeginTransaction(System.Data.IsolationLevel.Unspecified);
            // Enlist the command in the current transaction.
            myCommand.Transaction = myTrans;
            try
            {
        ...
        public void IsloationLevelSerializable()
        {
            ...
            // Start a local transaction.
            TrafDbTransaction myTrans = testInfo.connection.BeginTransaction(System.Data.IsolationLevel.Serializable);
            // Enlist the command in the current transaction.
            myCommand.Transaction = myTrans;
            try
            {
        ...
        public void IsloationLevelRepeatableRead()
        {
            ...
            // Start a local transaction.
            TrafDbTransaction myTrans = testInfo.connection.BeginTransaction(System.Data.IsolationLevel.RepeatableRead);
            // Enlist the command in the current transaction.
            myCommand.Transaction = myTrans;
            try
            {
        ...
        public void IsloationLevelSnapshot()
        {
            ...
            // Start a local transaction.
            TrafDbTransaction myTrans = testInfo.connection.BeginTransaction(System.Data.IsolationLevel.Snapshot);
            // Enlist the command in the current transaction.
            myCommand.Transaction = myTrans;
            try
            {
