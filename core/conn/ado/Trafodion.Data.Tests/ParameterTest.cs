...
namespace TrafAdoTest
{
    ...
    class ParameterTest
    {
        ...
        */ 
        ...
        {
            parm = new TrafDbParameter("testParm", TrafDbDbType.Integer);
        ...
        {
            parm = new TrafDbParameter("testParm",2);
            cmd.Parameters.Add(parm);
       ...
       // [Ignore]
        {
            //parm = new TrafDbParameter("testParm", TrafDbDbType.Double, 4, "test_parameter");
            //cmd.Parameters.Add(parm);
