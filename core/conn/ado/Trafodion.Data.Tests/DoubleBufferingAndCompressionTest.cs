...
namespace TrafAdoTest
{
    ...
    public class DoubleBufferingAndCompressionTest
    {
        ...
        public void TestWithNoneEnabled()
        {
            ...
            TrafDbDataAdapter adpw = new TrafDbDataAdapter();
            TrafDbCommandBuilder cb = new TrafDbCommandBuilder(adpw);

            adpw.SelectCommand = selectCmd; 
            adpw.UpdateCommand = (TrafDbCommand)cb.GetUpdateCommand();
            adpw.DeleteCommand = (TrafDbCommand)cb.GetDeleteCommand();
            adpw.InsertCommand = (TrafDbCommand)cb.GetInsertCommand();
            ...
            TrafDbDataAdapter adpr = new TrafDbDataAdapter();
            adpr.SelectCommand = selectCmd;
            adpr.UpdateCommand = (TrafDbCommand)cb.GetUpdateCommand();
            adpr.DeleteCommand = (TrafDbCommand)cb.GetDeleteCommand();
            adpr.InsertCommand = (TrafDbCommand)cb.GetInsertCommand();
