...
namespace TrafAdoTest
{
    ...
    public struct aColumn
    {
        ...
        public TrafDbDbType dbType;
        public string systemType;
        public string expectedError;
        public string actutalError;
        public bool errorFound;

        public aColumn(string name, int size, int prec, int scale, string inVal, string expVal, TrafDbDbType dbType, string systemType)
        {
    ...
    public class TestObject
    {
        ...
        public TrafDbConnection connection;
        ...
        private void generate_data()
        {
            ...
            for (int i = 1; i <= 10; i++)
            {
                ...
                aRow.Add(new aColumn(name_bank[0], 500, 0, 0,
                    ...
                    TrafDbDbType.Char, "String"));//C01 500
                ...
                aRow.Add(new aColumn(name_bank[16], 0, 0, 0, "-12345678", "-12345678", TrafDbDbType.Integer, "Int32"));//C17 integer signed
                aRow.Add(new aColumn(name_bank[17], 0, 0, 0, "12345678", "12345678", TrafDbDbType.IntegerUnsigned, "UInt32"));//C18 integer unsigned
                aRow.Add(new aColumn(name_bank[18], 0, 0, 0, i.ToString(), i.ToString(), TrafDbDbType.LargeInt, "Int64"));//C19 largeint
                aRow.Add(new aColumn(name_bank[19], 0, 0, 0, "-0.567", "-0.567", TrafDbDbType.Real, "Single"));//C20 real
                aRow.Add(new aColumn(name_bank[20], 0, 54, 0, "-0.1234567", "-0.1234567", TrafDbDbType.Float, "Double"));//C21 float
                aRow.Add(new aColumn(name_bank[21], 0, 0, 0, "0.12345678901234499", "0.123456789012345", TrafDbDbType.Double, "Double"));//C22 double precision
                aRow.Add(new aColumn(name_bank[22], 0, 0, 0, "2008-04-03", "2008-04-03", TrafDbDbType.Date, "DateTime"));//C23 date
                aRow.Add(new aColumn(name_bank[23], 0, 0, 0, "19:12:10", "19:12:10", TrafDbDbType.Time, "TimeSpan"));//C24 time
                aRow.Add(new aColumn(name_bank[24], 0, 0, 0, "2008-04-03 19:12:10.123", "2008-04-03 19:12:10.123000", TrafDbDbType.Timestamp, "DateTime"));//C25 timestamp
                aRow.Add(new aColumn(name_bank[25], 0, 128, 32, "-1.1234567890123456789012345678901234567890", "-1.12345678901234567890123456789012", TrafDbDbType.Numeric, "Decimal"));//C26 bignum signed
                aRow.Add(new aColumn(name_bank[26], 0, 128, 32, "1.1234567890123456789012345678901234567890", "1.12345678901234567890123456789012", TrafDbDbType.NumericUnsigned, "Decimal"));//C27 bignum unsigned
                aRow.Add(new aColumn(name_bank[27], 0, 0, 0, "2", "2", TrafDbDbType.Interval, "String"));//C28 INTERVAL YEAR
                aRow.Add(new aColumn(name_bank[28], 0, 0, 0, "2", "2", TrafDbDbType.Interval, "String"));//C29 INTERVAL MONTH
                aRow.Add(new aColumn(name_bank[29], 0, 0, 0, "2", "2", TrafDbDbType.Interval, "String"));//C30 INTERVAL DAY
                aRow.Add(new aColumn(name_bank[30], 0, 0, 0, "2", "2", TrafDbDbType.Interval, "String"));//C31 INTERVAL HOUR
                aRow.Add(new aColumn(name_bank[31], 0, 0, 0, "2", "2", TrafDbDbType.Interval, "String"));//C32 INTERVAL MINUTE
                aRow.Add(new aColumn(name_bank[32], 0, 0, 0, "2", "2.000000", TrafDbDbType.Interval, "String"));//C33 INTERVAL SECOND
                aRow.Add(new aColumn(name_bank[33], 0, 0, 0, "02-07", "2-07", TrafDbDbType.Interval, "String"));//C34 INTERVAL YEAR TO MONTH
                aRow.Add(new aColumn(name_bank[34], 0, 0, 0, "63 12", "63 12", TrafDbDbType.Interval, "String"));//C35 INTERVAL DAY TO HOUR
                aRow.Add(new aColumn(name_bank[35], 0, 0, 0, "63 12:39", "63 12:39", TrafDbDbType.Interval, "String"));//C36 DAY TO MINUTE
                aRow.Add(new aColumn(name_bank[36], 0, 0, 0, "63 12:39:59.163000", "63 12:39:59.163000", TrafDbDbType.Interval, "String"));//C37 DAY TO SECOND
                aRow.Add(new aColumn(name_bank[37], 0, 0, 0, "63:39", "63:39", TrafDbDbType.Interval, "String"));//C38 INTERVAL HOUR TO MINUTE
                aRow.Add(new aColumn(name_bank[38], 0, 0, 0, "63:39:59.163000", "63:39:59.163000", TrafDbDbType.Interval, "String"));//C39 INTERVAL HOUR TO SECOND
                aRow.Add(new aColumn(name_bank[39], 0, 0, 0, "39:59.163000", "39:59.163000", TrafDbDbType.Interval, "String"));//C40 INTERVAL MINUTE TO SECOND
                aRow.Add(new aColumn(name_bank[40], 20, 0, 0, "null", string.Empty, TrafDbDbType.Char, "String"));//C41 CHAR(20)
                aRow.Add(new aColumn(name_bank[41], 20, 0, 0, "null", string.Empty, TrafDbDbType.Char, "String"));//C42 NCHAR(20)
                aRow.Add(new aColumn(name_bank[42], 20, 0, 0, "null", string.Empty, TrafDbDbType.Varchar, "String"));//C43 VARCHAR(20)
                aRow.Add(new aColumn(name_bank[43], 20, 0, 0, "null",string.Empty, TrafDbDbType.Char, "String"));//C44 NVARCHAR(20)
                aRow.Add(new aColumn(name_bank[44], 0, 0, 0, "null", string.Empty, TrafDbDbType.Integer, "Int32"));//C45 INTEGER
        ...
        private void insert_rows(TrafDbCommand cmd, string tName)
        {
            try
            {
        ...
        //public bool CompareData(TrafDbDataReader reader, CommandBehavior cmdBehaviour, Helper.fetchType fType)
        //{
        //    bool pass = true;
        ...
        //public bool CompareData(TrafDbDataReader reader, Helper.fetchType fType)
        //{
        //    bool pass = true;
        //    int i = 1;
        //    foreach (ArrayList aRow in this.tableInfo)
        ...
        //private bool cmp_one_row(ArrayList aRow, TrafDbDataReader reader, Helper.fetchType fType)
        //{
        //    bool pass = true;
        ...
        //public void HPDbErrorCollector(TrafDbException oe)
        //{
        //    Console.WriteLine("============================================================");
        //    Console.WriteLine("ErrorCode: " + oe.ErrorCode);
        //    foreach (TrafDbError oErr in oe.Errors)
        //    {
