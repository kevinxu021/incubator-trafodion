    ...
    public sealed class TrafDbCommand : DbCommand, IDbCommand, ICloneable
    {
        ...
        public override CommandType CommandType
        {
            ...
            set
            {
                ...
                {
                    throw new TrafDbException(TrafDbMessage.UnsupportedCommandType, null, value.ToString());
                }
        ...
        /// <summary>
        /// Gets or sets how command results are applied to the DataRow when used by the Update method of the TrafDbDataAdapter. 
        /// </summary>
        ...
        IDbConnection IDbCommand.Connection
        {
            ...
            set
            {
                this.Connection = (TrafDbConnection)value;
            }
        }
        ...
        IDbTransaction IDbCommand.Transaction
        {
            ...
            set
            {
                this.Transaction = (TrafDbTransaction)value;
            }
        }

        internal TrafDbDataReader DataReader
        {
            get
            {
                return this._reader;
        ...
        public new void Dispose()
        {
            if (TrafDbTrace.IsPublicEnabled)
            {
                TrafDbTrace.Trace(this.Connection, TraceLevel.Public);
            }
        ...
        /// <summary>
        /// Creates a new instance of a TrafDbParameter object.
        /// </summary>
        /// <returns>A TrafDbParameter object.</returns>
        public new TrafDbParameter CreateParameter()
        {
            return new TrafDbParameter();
        }

        /// <summary>
        /// Sends the CommandText to the Connection and builds a TrafDbDataReader.
        /// </summary>
        /// <returns>A TrafDbDataReader object.</returns>
        public new TrafDbDataReader ExecuteReader()
        {
            return this.ExecuteReader(CommandBehavior.Default);
        }

        /// <summary>
        /// Sends the CommandText to the Connection, and builds a TrafDbDataReader using one of the CommandBehavior values.
        /// </summary>
        /// <param name="behavior">One of the CommandBehavior values.</param>
        /// <returns>A TrafDbDataReader object.</returns>
        public new TrafDbDataReader ExecuteReader(CommandBehavior behavior)
        {
            if (TrafDbTrace.IsPublicEnabled)
            {
                TrafDbTrace.Trace(this._conn, TraceLevel.Public, behavior);
            }
            ...
            {
                this._reader = new TrafDbDataReader(this);
            }
        ...
        public override int ExecuteNonQuery()
        {
            if (TrafDbTrace.IsPublicEnabled)
            {
                TrafDbTrace.Trace(this._conn, TraceLevel.Public,this._commandText);
            }
        ...
        public override object ExecuteScalar()
        {
            ...
            using (TrafDbDataReader dr = this.ExecuteReader())
            {
                dr.FetchSize = 1;
        ...
        public override void Prepare()
        {
            ...
            if (!this._isPrepared)
            {
                ...
                {
                    ex = new TrafDbException(this._prepareReply.errorList);
        ...
        /// Sends the CommandText to the Connection and builds a TrafDbDataReader.
        /// </summary>
        /// <returns>TrafDbDataReader</returns>
        ...
        object ICloneable.Clone()
        {
            ...
            foreach (TrafDbParameter parameter in Parameters)
            {
        ...
        private void Execute()
        {
            ...
            if ((qt == QueryType.CallNoResults || qt == QueryType.CallWithResults) && reply.data != null && reply.data.Length > 0)
            {
                ...
                this._reader = new TrafDbDataReader(this, null, paramReply);
                this._reader.Read();
            ...
            {
                this._reader = new TrafDbDataReader(this, this._prepareReply, reply);
            }
            else if (reply.outputDesc.Length > 0)
            {
                this._reader = new TrafDbDataReader(this, null, reply);
            }
        ...
        {
            TrafDbCommand command = (TrafDbCommand)source;
            command.Cancel();
        }
        //batch support
