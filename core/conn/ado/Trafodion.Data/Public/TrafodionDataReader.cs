namespace Trafodion.Data
{
    ...
    public sealed class TrafDbDataReader : DbDataReader, IDataReader
    {
        ...
        // no data constructor
        internal TrafDbDataReader(TrafDbCommand cmd)
        {
            if (TrafDbTrace.IsPublicEnabled)
            {
                TrafDbTrace.Trace(cmd.Connection, TraceLevel.Public);
            }
        ...
        internal TrafDbDataReader(TrafDbCommand cmd, PrepareReply prepareReply, ExecuteReply executeReply)
        {
            if (TrafDbTrace.IsPublicEnabled)
            {
                TrafDbTrace.Trace(cmd.Connection, TraceLevel.Public);
 ...
 //           }
        ...
        /// <summary>
        /// Gets a value that indicates whether the TrafDbDataReader contains one or more rows.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves a Boolean value that indicates whether the specified TrafDbDataReader instance has been closed. 
        /// </summary>
        ...
        public int FetchSize
        {
            ...
            set
            {
                if (value < 0)
                {
                    TrafDbException.ThrowException(this._cmd.Connection, new ArgumentOutOfRangeException("FetchSize cannot be less than 0."));
                }
        ...
        /// <summary>
        /// Releases all resources used by the current instance of the TrafDbDataReader class.
        /// </summary>
        ...
        /// <summary>
        /// Closes the TrafDbDataReader object.
        /// </summary>
            ...
            if (!this._isClosed)
            {
                ...
                if (!this._endOfData || this._freeOnClose)
                {
                    ...
                    switch (reply.error)
                    {
                        ...
                        default:
                            TrafDbException.ThrowException(this._cmd.Connection, new InternalFailureException("CloseReader: " + reply.error.ToString() + " " + reply.errorDetail + " " + reply.errorText, null));
                            break;
                    }
                }
        ...
        /// <summary>
        /// Returns an IEnumerator that iterates through the TrafDbDataReader.
        /// </summary>
        /// <returns>An IEnumerator for the TrafDbDataReader.</returns>
        ...
        public override Type GetFieldType(int ordinal)
        {
            ...
            switch (desc.TrafDbDataType)
            {
                ...
                case TrafDbDbType.Interval:
                    t = typeof(string);
                    break;
                case TrafDbDbType.Timestamp:
                case TrafDbDbType.Date:
                    t = typeof(DateTime);
                    break;
                case TrafDbDbType.Time:
                    t = typeof(TimeSpan);
                    break;
                case TrafDbDbType.Integer:
                    t = typeof(int);
                    break;
                case TrafDbDbType.IntegerUnsigned:
                    t = typeof(uint);
                    break;
                case TrafDbDbType.Decimal:
                case TrafDbDbType.DecimalUnsigned:
                case TrafDbDbType.Numeric:
                case TrafDbDbType.NumericUnsigned:
                    ...
                    break;
                case TrafDbDbType.Double:
                case TrafDbDbType.Float:
                    t = typeof(double);
                    break;
                case TrafDbDbType.Real:
                    t = typeof(float);
                    break;
                case TrafDbDbType.LargeInt:
                    t = typeof(long);
                    break;
                case TrafDbDbType.SmallInt:
                    t = typeof(short);
                    break;
                case TrafDbDbType.SmallIntUnsigned:
                    t = typeof(ushort);
                    break;
                default:
        ...
        /// <summary>
        /// Returns a DataTable that describes the column metadata of the TrafDbDataReader.
        /// </summary>
        /// <returns>A DataTable that describes the column metadata.</returns>
        /// <exception cref="InvalidOperationException">The TrafDbDataReader is closed.</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Advances the TrafDbDataReader to the next record.
        /// </summary>
        ...
        private void Fetch()
        {
            ...
            {
                this.Dispose();
                TrafDbException.ThrowException(null,new TrafDbException(TrafDbMessage.StmtInvalid, null));
            }
            ...
            switch (reply.returnCode)
            {
                ...
                case ReturnCode.SuccessWithInfo:
                    ex = new TrafDbException(reply.errorList);
