namespace EsgynDB.Data.Installation
{
    using System;
    ...
    public class InstallHelper : System.Configuration.Install.Installer
    {
        ...
        private static readonly string FactoryType = typeof(EsgynDBFactory).AssemblyQualifiedName;

        private static readonly Assembly EsgyndbDataEsgyndb = Assembly.GetAssembly(typeof(EsgynDB.Data.EsgynDBFactory));
        private static readonly Assembly EsgyndbVisualStudio = Assembly.GetAssembly(typeof(EsgynDB.Data.VisualStudio.AssemblyReference));
        ...
        private void InstallMachineConfig()
        {
            try
            {
                string name = ((AssemblyTitleAttribute)EsgyndbDataEsgyndb.GetCustomAttributes(
                   typeof(AssemblyTitleAttribute), false)[0]).Title;
                string description = ((AssemblyDescriptionAttribute)EsgyndbDataEsgyndb.GetCustomAttributes(
        ...
        private void InstallReferenceDialog(IDictionary savedState)
        {
            ...
            key.SetValue(null, Path.GetDirectoryName(EsgyndbDataEsgyndb.Location));
        ...
        private void InstallDDEX(IDictionary savedState)
        {
            ...
            foreach (string version in VersionList)
            {
                ...
                key.SetValue("Assembly", EsgyndbDataEsgyndb.FullName);
                ...
                key.SetValue("Assembly", EsgyndbVisualStudio.FullName);
