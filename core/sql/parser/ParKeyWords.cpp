...
ParKeyWord ParKeyWords::keyWords_[] = {
  ...
  ParKeyWord("ASYNCHRONOUS",       TOK_ASYNCHRONOUS,     NONRESTOKEN_),
  ParKeyWord("AT",                 TOK_AT,      NONRESTOKEN_),
  ...
  ParKeyWord("HBASE_AUTHS",  TOK_HBASE_AUTHS,      NONRESTOKEN_),
  ...
  ParKeyWord("HBASE_VISIBILITY",  TOK_HBASE_VISIBILITY,      NONRESTOKEN_),
  ...
  ParKeyWord("HIVEPARTFUNC",       TOK_HIVEPARTFUNC, NONRESTOKEN_),
...
// PATH is already used in CQS ...
  ...
  ParKeyWord("REGIONS",            TOK_REGIONS,     NONRESTOKEN_),
  ...
  ParKeyWord("REPLICATION",          TOK_REPLICATION,   NONRESTOKEN_),
  ...
  ParKeyWord("SPLIT",              TOK_SPLIT,     NONRESTOKEN_),
...
// used in QAT tests
  ...
  ParKeyWord("STDDEV_SAMP",        TOK_STDDEV_SAMP,      NONRESTOKEN_),
  ParKeyWord("STDDEV_POP",         TOK_STDDEV_POP,      NONRESTOKEN_),
  ...
  ParKeyWord("SYNCHRONOUS",        TOK_SYNCHRONOUS,     NONRESTOKEN_),
  ...
  ParKeyWord("VARIANCE_SAMP",      TOK_VARIANCE_SAMP,    NONRESTOKEN_),
  ParKeyWord("VARIANCE_POP",      TOK_VARIANCE_POP,    NONRESTOKEN_),
