...
const IntegerStatistics& IntegerStatistics::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_orc_5fproto_2eproto();  return *default_instance_;
}
...
const ::std::string StringStatistics::_default_minimum_;
const ::std::string StringStatistics::_default_maximum_;
#ifndef _MSC_VER
...
void StringStatistics::SharedCtor() {
  _cached_size_ = 0;
  minimum_ = const_cast< ::std::string*>(&_default_minimum_);
  maximum_ = const_cast< ::std::string*>(&_default_maximum_);
  sum_ = GOOGLE_LONGLONG(0);
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
const ::std::string DecimalStatistics::_default_minimum_;
const ::std::string DecimalStatistics::_default_maximum_;
const ::std::string DecimalStatistics::_default_sum_;
#ifndef _MSC_VER
...
void DecimalStatistics::SharedCtor() {
  ...
  minimum_ = const_cast< ::std::string*>(&_default_minimum_);
  maximum_ = const_cast< ::std::string*>(&_default_maximum_);
  sum_ = const_cast< ::std::string*>(&_default_sum_);
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
const ::std::string StripeFooter::_default_writertimezone_;
#ifndef _MSC_VER
...
void StripeFooter::SharedCtor() {
  _cached_size_ = 0;
  writertimezone_ = const_cast< ::std::string*>(&_default_writertimezone_);
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
      ...
      case 3: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_fieldNames:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->fieldnames(0).data(), this->fieldnames(0).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
...
const ::std::string UserMetadataItem::_default_name_;
const ::std::string UserMetadataItem::_default_value_;
#ifndef _MSC_VER
...
const ::std::string PostScript::_default_magic_;
#ifndef _MSC_VER
