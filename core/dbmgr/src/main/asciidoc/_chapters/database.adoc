...
*Insertable*::
Indicates if the view is insertable. Single table views can be insertable. Multi-table views cannot be insertable. Refer to the EsgynDB SQL Reference manual for more details.
