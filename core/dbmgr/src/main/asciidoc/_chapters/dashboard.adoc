...
The dashboard page by default auto-refreshes every 30 seconds and displays the more current status. You can change the time window or turn OFF auto-refresh using the *Auto Refresh* drop-down control.
