...
int CHbaseTM::initJVM() 
{
  ...
  JavaMethods_[JM_ABORT      ].jm_name      = "abortTransactionCommon";
  JavaMethods_[JM_ABORT      ].jm_signature = "(J)S";
  JavaMethods_[JM_PRECOMMIT  ].jm_name      = "prepareCommitCommon";
  JavaMethods_[JM_PRECOMMIT  ].jm_signature = "(J)S";
  JavaMethods_[JM_DOCOMMIT   ].jm_name      = "doCommitCommon";
  ...
  JavaMethods_[JM_COMPLETEREQUEST].jm_name      = "completeRequestCommon";
