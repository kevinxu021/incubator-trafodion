...
public:
   ...
   int registerRegion(int64 pv_transid, int64 pv_startid, const char pa_region[], int64 pv_hashcode, const char pa_regionInfo[], int pv_regionInfo_Length, int pv_peerId) {return FEOK; }
